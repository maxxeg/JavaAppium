...
public class MainPageObject
{
  ...
  public List<WebElement> searchArticles(String locator) {
    By by = this.getLocatorByString(locator);
  ...
  public void clickOnEmptyPlace(int x, int y) {
    if (driver instanceof AppiumDriver) {
      TouchAction action = new TouchAction((AppiumDriver) driver);
      action
      ...
      System.out.println("Method clickOnEmptyPlace() does nothing for platform " + Platform.getInstance().getPlatformVar());
    }
  ...
  public void assertElementPresent(String locator, String error_message) {
    int amountOfElements = getAmountOfElements(locator);
    if (amountOfElements == 0){
      String default_message = "An element '" + locator + "' supposed present";
      throw new AssertionError(default_message + " " + error_message);
    }
  }
